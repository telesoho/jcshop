...
//	    	'limit' => 10,
	...
	'getArticleGoods' => array(
		'query' => array(
			...
			'where'  => 'r.article_id in (#article_id#) and go.id is not null and go.is_del = 0',
			'fields' => 'go.goods_no as goods_no,go.id as goods_id,go.img,go.name,go.market_price,go.sell_price,go.is_del',
		)
	),
	//获取全部特价商品活动
	'getSaleList' => array(
