...
class wechat extends pluginBase
{
	...
	public $config = array(
		...
		'wechat_AppSecret' => 'cdb9ea87d59246fb26cf0632c902a1c0',
		'wechat_AutoLogin' => '',
		'wechat_jsApiSDK'  => '',
	);
	...
	public function msgCatch($postObj)
	{
		switch($postObj->MsgType)
		{
			...
			default:
			{
				$this->textReplay("Hey~~亲爱的喵们！ 欢迎来到九猫家微信服务号~ 九猫家是由日本商社和品牌方直供的跨境电商平台，我们承诺所有商品，官方直供，东京直邮，同时为您提供更具优势的价格。 立刻点击下方“九猫大百货”逛逛逛吧~！ 偷偷告诉你：添加九猫个人微信：jiumaojia001 加入九猫VIP群，群里发放购物优惠券哦~");
			}
		}
	}
