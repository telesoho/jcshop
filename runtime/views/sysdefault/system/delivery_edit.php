				...
				<tr>
					...
					<td>
						...
						<div class='content_box' style='padding:6px'>
							...
							<label class='attr'><a href="javascript:void(0)" onclick="$(this).parent().parent().remove();"><img alt="删除" src="<?php echo $this->getWebSkinPath()."images/admin/icon_del.gif";?>" class="operator"/></a></label>
