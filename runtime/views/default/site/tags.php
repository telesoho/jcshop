...
<div class="container">
	...
	<div class="position"> <span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>"> 首页</a> » 标签 </div>
<div class="wrapper clearfix">

	<div class="tag_box">
		<?php $classArray = array('bold orange','orange');$colorIndex=0;?>
		<?php foreach(Api::run('getKeywordAllList',50) as $key => $item){?>
		<?php $keyword=urlencode($item['word']);?>
		<a href="<?php echo IUrl::creatUrl("/site/search_list/word/".$keyword."");?>" class="<?php echo $classArray[$colorIndex%count($classArray)];?>"><?php echo isset($item['word'])?$item['word']:"";?></a>
		<?php $colorIndex++;?>
		<?php }?>
	</div>
